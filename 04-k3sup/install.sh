...
k3sup install --cluster --ip ${K3S_SERVER_NODES_IPS[0]} --tls-san $K8S_HA_API_VIP --user pveuser --ssh-key $SSH_KEY_PATH --local-path $KUBECONFIG --k3s-extra-args '--flannel-backend=none --disable-network-policy --disable-kube-proxy'
